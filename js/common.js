						...
						onSelect:function(){
								...
								if(objLen%2==0)
								{
									for(i=0;i<items;i++){
										stratTime = $(obj[i+j]);
										endTime = $(obj[i+j+1]);
										stratTimeVal = stratTime.val();
										endTimeVal = endTime.val();		
										if(stratTime.length>0)
										{
											stratTimeVal = NewDate(stratTimeVal).getTime();
											endTimeVal = NewDate(endTimeVal).getTime();
            ...
            slideFn:function(options){
                ...
                this.each(function(){
                    ...
                    var slideTop = function(box){
                        ...
                        box.animate({"marginTop":-oLiHeight+"px"},400,function(){
                    ...
                    var slideLeft = function(box2){
                       // box2.css("width",((oLi.width())*(oLi.length))+"px");
                        ...
                        box2.animate({"marginLeft":-oLiWidth+"px"},400,function(){
                ...
                this.each(function(){
                    ...
                    var oLiClick = function(){
                        ...
                        oLi.click(function(){
                            ...
                            if (index == 0 && $(oLi[index]).text() == "公司动态") {
                                oLi.eq(2).show();
                                oLi.eq(3).hide();
                            }else if(index == 1 && $(oLi[index]).text() == "行业资讯"){
                                oLi.eq(2).hide();
                                oLi.eq(3).show();
                            }
                        })
...
*/
    ...
    $.fn.bxCarousel = function(options) {
        ...
        return this.each(function() {
            ...
            /*$this.parent('.bx_container').append('<div class="show-container"></div>').css({
